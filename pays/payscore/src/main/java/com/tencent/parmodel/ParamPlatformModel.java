...
public class ParamPlatformModel {
	...
	public static void setAppsecret(String appsecret) {
		ParamPlatformModel.appsecret = appsecret;
	}
	...
	public static void setUseThreadToDoReport(boolean useThreadToDoReport) {
		ParamPlatformModel.useThreadToDoReport = useThreadToDoReport;
	}

	public static String HttpsRequestClassName = "com.tencent.common.HttpsRequest";

	public void setKey(String key) {
		ParamPlatformModel.key = key;
	}

	public static void setAppID(String appID) {
		ParamPlatformModel.appID = appID;
	}

	public static void setMchID(String mchID) {
		ParamPlatformModel.mchID = mchID;
	}

	public static void setSubMchID(String subMchID) {
		ParamPlatformModel.subMchID = subMchID;
	}

	public static void setCertLocalPath(String certLocalPath) {
		ParamPlatformModel.certLocalPath = certLocalPath;
	}

	public static void setCertPassword(String certPassword) {
		ParamPlatformModel.certPassword = certPassword;
	}

	public static void setIp(String ip) {
		ParamPlatformModel.ip = ip;
	}
