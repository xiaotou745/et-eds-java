...
public class CrossShopStatisticLog {
    ...
    private Integer threetimescount;

    private Integer fourtimescount;

    private Integer fivetimescount;

    private Integer sixtimescount;

    private Integer seventimescount;

    private Integer eighttimescount;

    private Integer ninetimescount;
    ...
    public Integer getTwicecount() {
        return twicecount;
    }

    public void setTwicecount(Integer twicecount) {
        this.twicecount = twicecount;
    }

    public Integer getThreetimescount() {
        return threetimescount;
    }

    public void setThreetimescount(Integer threetimescount) {
        this.threetimescount = threetimescount;
    }

    public Integer getFourtimescount() {
        return fourtimescount;
    }

    public void setFourtimescount(Integer fourtimescount) {
        this.fourtimescount = fourtimescount;
    }

    public Integer getFivetimescount() {
        return fivetimescount;
    }

    public void setFivetimescount(Integer fivetimescount) {
        this.fivetimescount = fivetimescount;
    }

    public Integer getSixtimescount() {
        return sixtimescount;
    }

    public void setSixtimescount(Integer sixtimescount) {
        this.sixtimescount = sixtimescount;
    }

    public Integer getSeventimescount() {
        return seventimescount;
    }

    public void setSeventimescount(Integer seventimescount) {
        this.seventimescount = seventimescount;
    }

    public Integer getEighttimescount() {
        return eighttimescount;
    }

    public void setEighttimescount(Integer eighttimescount) {
        this.eighttimescount = eighttimescount;
    }

    public Integer getNinetimescount() {
        return ninetimescount;
    }

    public void setNinetimescount(Integer ninetimescount) {
        this.ninetimescount = ninetimescount;
    }

    public Integer getExceedninetimescount() {
        return exceedninetimescount;
    }

    public void setExceedninetimescount(Integer exceedninetimescount) {
