...
import com.edaisong.api.service.inter.IOrderTipCostService;
...
@Service
public class OrderTipCostService implements IOrderTipCostService {

	@Autowired
	private IOrderTipCostDao iOrderTipCostDao;

	@Override
	public int insertSelective(OrderTipCost record)
	{
		return iOrderTipCostDao.insertSelective(record);
	}
