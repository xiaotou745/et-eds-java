...
public class ClienterPushLogDao extends DaoBase implements IClienterPushLogDao {
	...
	public int insert(ClienterPushLog clienterPushLog) {
		return getMasterSqlSessionUtil().insert("IClienterPushLogDao.insert", clienterPushLog);
	}
	...
	public void update(ClienterPushLog clienterPushLog) {
		getMasterSqlSessionUtil().update("IClienterPushLogDao.update", clienterPushLog);
	}
	...
	public void delete(Long iD) {
		getMasterSqlSessionUtil().delete("IClienterPushLogDao.delete", iD);
	}
	...
	public ClienterPushLog getById(Long iD) {
		return getMasterSqlSessionUtil().selectOne("IClienterPushLogDao.getById", iD);
	}
	...
	public ClienterPushLog selectByOrderId(Long orderId){
		return getMasterSqlSessionUtil().selectOne("IClienterPushLogDao.selectByOrderId", orderId);
	}
	/**
	...
	public Integer updateProcessTime(Long id) {
		return getMasterSqlSessionUtil().update("IClienterPushLogDao.updateProcessTime", id);
	}
