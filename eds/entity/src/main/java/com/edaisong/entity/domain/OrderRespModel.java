...
public class OrderRespModel {
	...
	private String clienterHeadPhoto;
	...
	public String getClienterHeadPhoto() {
		return clienterHeadPhoto;
	}
	public void setClienterHeadPhoto(String clienterHeadPhoto) {
		this.clienterHeadPhoto = clienterHeadPhoto;
	}
