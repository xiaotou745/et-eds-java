...
<div class="box2">
	...
	<div class="box2-ny">
		<p class="cb">
			...
			</span> <input class="fl" type="text" id="telphone"> <em class="fl">请输入正确手机号码或固定电话号码</em>
		<ul id="list" class="vh">
			<!-- 加入 "vh" 选择器,为隐藏 -->
		...
		<p class="cb">
			...
			</span> <input class="fl" type="text" id="address"> <em class="fl">收货地址不能为空</em>
		</p>
		<p class="cb">
			<span class="fl"> <em class="fl">*</em> 收货人姓名
			</span> <input class="fl" type="text" id="name"> <em class="fl">随便写点啥提示</em>
		</p>
	</div>
</div>
<div class="box2">
...
<div class="popup popup1" style="display:none;">
	...
	<div class="popupBox popupBox1">
		...
		<p class="cb">
			...
			<em class="fl">￥41.00</em>
		</p>
		<p class="cb">
			<span class="fl">订单数量</span>
			<em class="fl">3</em>
		</p>
		<p class="cb">
		...
		<p class="cb">
			<span class="fl">订单总金额</span>
			<em class="fl">￥41.00</em>
		</p>
		<i>当前任务结算<s>45</s>元，剩余余额<s>6</s>元！</i>
		<a class="qx" href="javascript:;">取消</a>
		<a class="qr" href="javascript:;">确认</a>		<!-- class=“qr“ 加入选择器”ok"呼出任务发布成功弹层 -->  <!-- class=“qr“ 加入选择器”no"呼出任务发布成功弹层 -->
	</div>
</div>
...
<div class="popup popup3" style="display:none;">
	...
	<div class="popupBox popupBox3">
		...
		<img src="<%=basePath%>/images/yebz.png" alt="余额不足">
		<p>您的余额不足</p>
		<p>请通过客户端APP充值！</p>
	</div>
</div>
