...
public class VerificationCodeHelper {
	 ...
	 * @param code
	 */
	public static void storeAuthCode2Redis(String from, String code, String cookieKey, HttpServletRequest request,
	 ...
	 * @param response
	 */
	public static void removeAuthCodeCookie(HttpServletRequest request, HttpServletResponse response, String from,
			String cookieKey) {
